...
window.skins.sparrowsclm={};
	...
	function GameLayer() {
		_super.call(this);
		this.skinParts = ["BG","Logo","MenuBg","TableNum","CellNum","LastCards","Chat","Chat0","Chat1","Auto","Option","Back","Ready","ChangeDesk","Tips","Head1","Head2","Head0","Nick","ID","Score","Ready0","Ready1","Ready2"];
		
		this.height = 750;
		this.width = 1334;
		this.elementsContent = [this.BG_i(),this.Logo_i(),this.MenuBg_i(),this.TableNum_i(),this.CellNum_i(),this.LastCards_i(),this.Chat_i(),this.Chat0_i(),this.Chat1_i(),this.Auto_i(),this.Option_i(),this.Back_i(),this.Ready_i(),this.ChangeDesk_i(),this.Tips_i(),this.Head1_i(),this.Head2_i(),this.Head0_i(),this.Nick_i(),this.ID_i(),this.Score_i(),this.Ready0_i(),this.Ready1_i(),this.Ready2_i()];
	}
