...
window.skins.sparrowsclm={};
	...
	function GameLayer() {
		_super.call(this);
		this.skinParts = ["BG","Logo","MenuBg","TableNum","CellNum","LastCards","Chat","Chat0","Chat1","Auto","Option","Back","Ready","ChangeDesk","Tips","Head1","Head2","Head0","Nick","Nick1","Nick2","ID","ID1","ID2","Score","Score1","Score2","Ready0","Ready1","Ready2","ClcokBG","time0","clock0","time3","clock3","time2","clock2","time1","clock1","direction0","direction1","direction2","direction3"];
		
		this.height = 750;
		this.width = 1334;
		this.elementsContent = [this.BG_i(),this.Logo_i(),this.MenuBg_i(),this.TableNum_i(),this.CellNum_i(),this.LastCards_i(),this.Chat_i(),this.Chat0_i(),this.Chat1_i(),this.Auto_i(),this.Option_i(),this.Back_i(),this.Ready_i(),this.ChangeDesk_i(),this.Tips_i(),this.Head1_i(),this.Head2_i(),this.Head0_i(),this.Nick_i(),this.Nick1_i(),this.Nick2_i(),this.ID_i(),this.ID1_i(),this.ID2_i(),this.Score_i(),this.Score1_i(),this.Score2_i(),this.Ready0_i(),this.Ready1_i(),this.Ready2_i(),this.ClcokBG_i(),this.clock0_i(),this.clock3_i(),this.clock2_i(),this.clock1_i(),this.direction0_i(),this.direction1_i(),this.direction2_i(),this.direction3_i()];
	}
