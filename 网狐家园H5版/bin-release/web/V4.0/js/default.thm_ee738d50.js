...
window.skins.sparrowsclm={};
	...
	function GameLayer() {
		_super.call(this);
		this.skinParts = ["BG","Logo","back","OutCard","HandCard0","HandCard1","HandCard2","MenuBg","TableNum","CellNum","LastCards","Chat","Chat0","Chat1","Auto","Option","Back","Ready","ChangeDesk","Tips","Head2","Head_Normal2","Nick2","ID2","Score2","Ready2","UserInfo2","Head1","ID1","Nick1","Score1","Head_Normal1","Ready1","UserInfo1","Head0","Score","ID","Nick","Ready0","UserInfo0","ClcokBG","time0","clock0","time3","clock3","time2","clock2","time1","clock1","direction0","direction1","direction2","direction3","OpreatView","DeskCard0","DeskCard1","DeskCard2"];
		
		this.height = 750;
		this.width = 1334;
		this.elementsContent = [this.BG_i(),this.Logo_i(),this.OutCard_i(),this.HandCard0_i(),this.HandCard1_i(),this.HandCard2_i(),this.MenuBg_i(),this.TableNum_i(),this.CellNum_i(),this.LastCards_i(),this.Chat_i(),this.Chat0_i(),this.Chat1_i(),this.Auto_i(),this.Option_i(),this.Back_i(),this.Ready_i(),this.ChangeDesk_i(),this.Tips_i(),this.UserInfo2_i(),this.UserInfo1_i(),this.UserInfo0_i(),this.ClcokBG_i(),this.clock0_i(),this.clock3_i(),this.clock2_i(),this.clock1_i(),this.direction0_i(),this.direction1_i(),this.direction2_i(),this.direction3_i(),this.OpreatView_i(),this.DeskCard0_i(),this.DeskCard1_i(),this.DeskCard2_i()];
	}
	...
	_proto.back_i = function () {
		...
		t.height = 190;
		t.name = "back";
		t.source = "game_outcard_back_png";
		t.width = 150;
		t.x = 0;
		t.y = 0;
		return t;
	...
	_proto.UserInfo2_i = function () {
		...
		t.x = -115;
		t.y = 0;
		t.elementsContent = [this.Head2_i(),this.Head_Normal2_i(),this.Nick2_i(),this.ID2_i(),this.Score2_i(),this.Ready2_i()];
		return t;
	};
	...
	_proto.Head_Normal2_i = function () {
		var t = new eui.Image();
		this.Head_Normal2 = t;
		t.anchorOffsetX = 118;
		t.anchorOffsetY = 118;
	...
	_proto.UserInfo1_i = function () {
		...
		t.x = 115;
		t.y = 0;
		t.elementsContent = [this.Head1_i(),this.ID1_i(),this.Nick1_i(),this.Score1_i(),this.Head_Normal1_i(),this.Ready1_i()];
		return t;
	};
	...
	_proto.Head_Normal1_i = function () {
		var t = new eui.Image();
		this.Head_Normal1 = t;
		t.anchorOffsetX = 118;
		t.anchorOffsetY = 118;
	...
	_proto.UserInfo0_i = function () {
		...
		t.x = -580;
		t.y = 0;
		t.elementsContent = [this.Head0_i(),this.Score_i(),this.ID_i(),this.Nick_i(),this.Ready0_i()];
		return t;
	};
	...
	_proto.ClcokBG_i = function () {
		var t = new eui.Image();
		this.ClcokBG = t;
		t.anchorOffsetX = 83;
		t.height = 166;
		t.source = "game_time_back_png";
		t.width = 166;
		t.x = 667;
		t.y = 194;
		return t;
	};
	_proto.clock0_i = function () {
		var t = new eui.Panel();
		this.clock0 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		...
		t.x = 588;
		t.y = 308;
		t.elementsContent = [this.time0_i()];
		return t;
	};
	_proto.time0_i = function () {
		var t = new eui.Image();
		this.time0 = t;
		t.height = 54;
		t.name = "image";
		t.source = "game_time_normal_back_png";
		t.width = 166;
		t.x = -6;
		t.y = -3;
		return t;
	};
	_proto.clock3_i = function () {
		var t = new eui.Panel();
		this.clock3 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		...
		t.x = 636;
		t.y = 199;
		t.elementsContent = [this.time3_i()];
		return t;
	};
	...
	_proto.clock2_i = function () {
		...
		t.x = 745;
		t.y = 247;
		t.elementsContent = [this.time2_i()];
		return t;
	};
	...
	_proto.clock1_i = function () {
		...
		t.x = 699;
		t.y = 357;
		t.elementsContent = [this.time1_i()];
		return t;
	};
	...
	_proto.direction0_i = function () {
		var t = new eui.Image();
		this.direction0 = t;
		t.anchorOffsetX = 83;
		t.height = 54;
		t.name = "direction0";
		t.source = "game_east_0_png";
		t.width = 166;
		t.x = 667;
		t.y = 306;
		return t;
	};
	_proto.direction1_i = function () {
		var t = new eui.Image();
		this.direction1 = t;
		t.anchorOffsetX = 83;
		t.height = 54;
		t.name = "direction3";
		t.rotation = 90;
		t.source = "game_north_0_png";
		t.width = 166;
		t.x = 641;
		t.y = 276;
		return t;
	};
	_proto.direction2_i = function () {
		var t = new eui.Image();
		this.direction2 = t;
		t.anchorOffsetX = 83;
		t.fillMode = "clip";
		...
		t.name = "direction2";
		t.rotation = 180;
		t.source = "game_west_0_png";
		t.width = 166;
		t.x = 669;
		t.y = 247;
		return t;
	};
	_proto.direction3_i = function () {
		var t = new eui.Image();
		this.direction3 = t;
		t.anchorOffsetX = 83;
		t.fillMode = "clip";
		...
		t.name = "direction1";
		t.rotation = 270;
		t.source = "game_south_0_png";
		t.width = 166;
		t.x = 694;
		t.y = 276;
		return t;
	};
	_proto.OpreatView_i = function () {
		var t = new eui.Panel();
		this.OpreatView = t;
		t.anchorOffsetX = 350;
		t.anchorOffsetY = 0;
