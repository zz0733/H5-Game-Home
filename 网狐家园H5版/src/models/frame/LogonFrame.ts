...
namespace frame {
    ...
    const LOGON_MODE_OTHERPLATFORM   		= 3   //第三方登录
    const LOGON_MODE_RELOADROOM             = 4   //重载房间
    const LOGON_MODE_RELOADAGENT            = 5   //重载房间
    const LOGON_MODE_RELOADGAME             = 6   //重载游戏
    ...
    export class LogonFrame {
        ...
        private _reLoadKind: number = 0;
        public onReLoadRoomList(kindID: number) {
        ...
        public onQueryServerAgent(kindID: number) {
