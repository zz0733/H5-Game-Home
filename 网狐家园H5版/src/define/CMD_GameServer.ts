...
namespace df {
    ...
    export const MDM_GR_LOGON = 1									//登录信息

    //登录模式
    export const SUB_GR_LOGON_USERID = 1							//I D 登录
    export const SUB_GR_LOGON_ACCOUNTS = 3							//帐户登录
    export const SUB_GR_LOGON_MOBILE = 4							//手机登录
    ...
    export class CMD_GR_LogonByMobile {
        ...
        public dwUserID: number = 0;					     //用户 I D
        public szPasspublic: string = "";				     //登录密码
        public szServerPasswdf: string = "";                 //房间密码
    ...
    export const MDM_GR_CONFIG = 2									    //配置信息
    ...
    export const MDM_GR_USER = 3									    //用户信息
    ...
    export const MDM_GR_STATUS = 4									    //状态信息
    ...
    export const MDM_GR_MEMBER = 6									//会员命令
    ...
    //用户属性
    export const DTP_GR_USER_ACCOUNTS = 10								//用户帐号
    export const DTP_GR_USER_GROUP_NAME = 11							//社团名字
    export const DTP_GR_USER_UNDER_WRITE = 12							//个性签名
